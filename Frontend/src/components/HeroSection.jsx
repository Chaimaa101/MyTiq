...
const HeroSection = () => {
  return (
 <div
  className="h-[450px] mt-[-25px] rounded-lg bg-cover bg-center flex items-center justify-center"
  ...
  <div className="w-full md:w-1/2 flex flex-col gap-4 bg-white/80 p-10 rounded-lg shadow-lg text-center">
    ...
    <div className="flex gap-2">
      <input
        ...
        className="p-3 rounded-lg w-full text-gray-800 outline-none border-2 border-gray-400"
      />
