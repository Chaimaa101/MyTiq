    ...
    <nav className="w-full bg-white shadow-sm">
      <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Link to="/connexion" className="block text-gray-700 border border-gray-300 px-4 py-2 rounded-md hover:bg-red-600 hover:text-white">Connexion</Link>
          <Link to="/inscription" className="block text-white bg-red-600 px-4 py-2 rounded-md hover:bg-red-700">S’inscrire</Link>
        </div>
        </div>
      </div>
