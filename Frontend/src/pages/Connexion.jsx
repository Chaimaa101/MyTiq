  ...
  return (   
    ...
    <h1 className="text-3xl font-bold text-center text-red-600 mb-6">MyTiq</h1>
      <div className="flex justify-center gap-4 mb-10 border-b-gray-300 bg-gray-300 text-gray-500 font-medium p-2 rounded w-fit mx-auto">
        <button className="px-4 py-1 rounded  bg-gray-100"><Link to="/connexion">Connexion</Link></button>
        <button className="px-4 py-1 rounded "><Link to="/inscription">Inscription</Link></button>
      </div>
      ...
      <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        <p className="text-center text-sm text-red-600 mt-2 cursor-pointer">
          Mot de passe oublié ?
        </p>
      </form>
    </div>
